...
if __name__ == '__main__':
    name = {'name': 'test2', 'times':0, 'productline': 'iat', 'alarm_group': 'jianshen2', 'ops': 'dhli', 'dev': 'jianliu', 'ifor': '1m','rc_name': 'xits-cnen.xits-cnen.1006'}
