...
class V1PrometheusRule(object):
    ...
    def __init__(self, api_version=None, kind=None, metadata=None, spec=None,status=None,reason=None):
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1PrometheusRule):
            return False
