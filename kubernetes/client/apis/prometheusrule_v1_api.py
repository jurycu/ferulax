...
class PrometheusRuleV1Api(object):
    """
    ...
    def create_namespaced_prometheusrule(self, namespace, body, **kwargs):
        """
        create a Pod
        ...
        if kwargs.get('async_req'):
            return self.create_namespaced_prometheusrule_with_http_info(namespace, body, **kwargs)
        else:
            (data) = self.create_namespaced_prometheusrule_with_http_info(namespace, body, **kwargs)
            return data

    def create_namespaced_prometheusrule_with_http_info(self, namespace, body, **kwargs):
        """
        create a Pod
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        return self.api_client.call_api('/apis/monitoring.coreos.com/v1/namespaces/{namespace}/prometheusrules', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_namespaced_prometheusrule(self, namespace, name, **kwargs):
        """
        create a Pod
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_namespaced_prometheusrule_with_http_info(namespace, name, **kwargs)
        else:
            (data) = self.delete_namespaced_prometheusrule_with_http_info(namespace, name, **kwargs)
            return data
    
    def delete_namespaced_prometheusrule_with_http_info(self, namespace, name, **kwargs):
        """
        create a Pod
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        all_params = ['namespace', 'name', 'pretty', 'dry_run', 'field_manager']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('name' not in params) or (params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `create_namespaced_pod`")
        ...
        return self.api_client.call_api('/apis/monitoring.coreos.com/v1/namespaces/{namespace}/prometheusrules/{name}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_collection_api_service(self,namespace, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_collection_api_service_with_http_info(namespace,**kwargs)
        else:
            (data) = self.delete_collection_api_service_with_http_info(namespace,**kwargs)
            return data

    def delete_collection_api_service_with_http_info(self,namespace, **kwargs):
        """
        delete collection of APIService
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        return self.api_client.call_api('/apis/monitoring.coreos.com/v1/namespaces/{namespace}/prometheusrules', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_api_resources_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/apis/monitoring.coreos.com/v1/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_namespaced_prometheusrule(self, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_namespaced_prometheusrule_with_http_info(**kwargs)
        else:
            (data) = self.list_namespaced_prometheusrule_with_http_info(**kwargs)
            return data

    def list_namespaced_prometheusrule_with_http_info(self, **kwargs):
        """
        list or watch objects of kind APIService
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        return self.api_client.call_api('/apis/monitoring.coreos.com/v1/prometheusrules', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def patch_namespaced_prometheusrule(self, namespace,name, body, **kwargs):
        """
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_namespaced_prometheusrule_with_http_info(name,namespace, body, **kwargs)
        else:
            (data) = self.patch_namespaced_prometheusrule_with_http_info(name, namespace,body, **kwargs)
            return data

    def patch_namespaced_prometheusrule_with_http_info(self, name,namespace, body, **kwargs):
        """
        partially update the specified APIService
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'])
            #select_header_accept(['application/json', 'application/vnd.kubernetes.protobuf'])
        ...
        return self.api_client.call_api('/apis/monitoring.coreos.com/v1/namespaces/{namespace}/prometheusrules/{name}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def patch_api_service_status_with_http_info(self, name, body, **kwargs):
        ...
        return self.api_client.call_api('/apis/monitoring.coreos.com/v1/prometheusrules/{name}/status', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def read_api_service_with_http_info(self, name, **kwargs):
        ...
        return self.api_client.call_api('/apis/monitoring.coreos.com/v1/prometheusrules/{name}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def read_api_service_status_with_http_info(self, name, **kwargs):
        ...
        return self.api_client.call_api('/apis/monitoring.coreos.com/v1/prometheusrules/{name}/status', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def replace_api_service_with_http_info(self, name, body, **kwargs):
        ...
        return self.api_client.call_api('/apis/monitoring.coreos.com/v1/prometheusrules/{name}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def replace_api_service_status_with_http_info(self, name, body, **kwargs):
        ...
        return self.api_client.call_api('/apis/monitoring.coreos.com/v1/prometheusrules/{name}/status', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
